...
#ifndef uTfeHexahedronShapeH
#define uTfeHexahedronShapeH
#include "uHexahedronShape.h"
#include "uTTail.h"
//---------------------------------------------------------------------------
class TTfeHexahedronShape: public THexahedronShape
{
  private:
   TTail *T0;
   TTail *T1;
  ...
  public:
   ...
   TTfeHexahedronShape(int X, int Y, int step, int number=0);//:TBaseShape(number);
   ~TTfeHexahedronShape();
